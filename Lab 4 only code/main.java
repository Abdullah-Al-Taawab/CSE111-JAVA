public class main
{
  ...
  {
    Bankaccount acc1=new Bankaccount("kalam","1212","khilgaon",120101.0);
    Bankaccount acc2=new Bankaccount("ron","1213","malibag",120101.0);
    Bankaccount acc3=new Bankaccount("shofiq","1214","bailey",120103.0);
